...
Each student was given the task to model a pair of related compounds with the objective to confirm the energetic and structural characteristics that drove the decision of the team of medicinal chemists at Merck. Their work was structure-based but for the most part it did not involve advanced molecular modeling.
